---
title: Analiza zbioru danych zawierającego informacje o winach pochodzących z północy
  Portugalii
output:
  html_document:
    toc: true
...
prediction_summary <- data.frame(matrix(ncol = 4, nrow = 0, dimnames = list(NULL, c("Name", "RSS", "Percentage of correctly classified cases","Percentage of classifications off by 1 class"))))
